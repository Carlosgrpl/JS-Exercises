...
const findCucushumushu = aliens.find((alien) => {
  return alien.name === "Cucushumushu";
});

const findPorompompero = mutations.find((mutation) => {
  return mutation.name === "Porompompero";
});

const addMutation = (findCucushumushu.mutation = findPorompompero);
